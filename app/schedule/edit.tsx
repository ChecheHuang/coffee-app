...
export default function EditScheduleScreen() {
  ...
  const { schedules, updateSchedule, removeSchedule } = useScheduleStore();
          ...
          <View className="flex-row items-center justify-center" style={{ gap: 8 }}>
            ...
            >
              <Pressable
                ...
                style={{ padding: 12 }}
              >
                <Text className="text-text-secondary" style={{ fontSize: 18 }}>‹</Text>
              </Pressable>
              <Text
            ...
            <Text className="font-display-light text-gold" style={{ fontSize: 42 }}>:</Text>
              ...
              return (
                <Pressable
                  ...
                  className={cn(
                    ...
                    isActive ? "bg-gold" : "bg-bg-card border border-border",
                  )}
                >
                  <Text
                    className={cn(
